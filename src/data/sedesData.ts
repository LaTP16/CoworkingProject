  ...
  "surco-pueblo": {
    ...
    spaces: [
      ...
      },
      {
        ...
        count: 5,
        iconName: "lock",
        description: "Oficinas cerradas e insonorizadas",
        rating: 4.92,
        reviewsCount: 19,
        images: [
          "/images/spaces/privados.jpg",
      ...
      },
      {
        ...
        count: 2,
        iconName: "users",
        description: "Espacios colaborativos dinámicos",
        rating: 4.85,
        reviewsCount: 22,
        images: [
          "/images/spaces/trabajo.jpg",
      ...
      },
      {
        ...
        count: 2,
        iconName: "briefcase",
        description: "Equipadas con pantallas interactivas y videoconferencia",
        rating: 4.9,
        reviewsCount: 16,
        images: [
          "/images/spaces/trabajo.jpg",
  ...
  castilla: {
    ...
    spaces: [
      ...
      },
      {
        ...
        count: 2,
        iconName: "lock",
        description: "Oficinas ejecutivas de alta gama (3 personas c/u)",
        rating: 5.0,
        reviewsCount: 12,
        images: [
          "/images/spaces/privados.jpg",
      ...
      },
      {
        ...
        count: 1,
        iconName: "briefcase",
        description: "Videoconferencia 4K ready para 8 personas",
        rating: 4.9,
        reviewsCount: 18,
        images: [
          "/images/spaces/trabajo.jpg",
      ...
      },
      {
        ...
        count: 1,
        iconName: "coffee",
        description: "Lounge de descanso, barra de café gourmet y networking",
        rating: 4.98,
        reviewsCount: 35,
        images: [
          "/images/sedes/castilla.jpg",
